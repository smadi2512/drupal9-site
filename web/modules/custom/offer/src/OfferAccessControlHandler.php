...
/**
 * Access controller for the offer entity. Controls creae/edit/delete access 
...
class OfferAccessControlHandler extends EntityAccessControlHandler {
   ...
   /**
    * @inheritDoc
    * Link the activities to the permisions. checkAccess is called with the 
   ...
   */
    ...
    * it will be created during 'add' process
    */
